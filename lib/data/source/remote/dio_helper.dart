...
class DioHelper {
  ...
  static Future<Response> getClassHouses(
    ...
    return dio.get(
        isComingFromHome == false
            ...
            : "${ApiKey.getSchoolHouses}?BranchId=$classroomToSectionId&Search=$search",
        options: Options(
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
  ...
  static Future<Response> getParentOffline(
      token, bool language, int search) async {
    return dio.get(
        "${ApiKey.getParentOffline}?isEnglishLanguage=$language&Search=$search",
        options: Options(
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
