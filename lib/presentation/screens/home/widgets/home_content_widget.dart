    ...
    return Column(
      children: [
        HomeAppBarWidget(
          ...
          schoolName: widget.isFather ?  widget.bloc.childName : widget.teacherHomeResponse.data?.schoolName ?? "",
          schoolImage: widget.isFather ? widget.bloc.schoolLogo: widget.teacherHomeResponse.data?.getLogo?.mediaUrl ?? "",
