...
class MyChildPointsWidget extends StatefulWidget {
  const MyChildPointsWidget({Key? key}) : super(key: key);

  @override
  State<MyChildPointsWidget> createState() => _MyChildPointsWidgetState();
}

class _MyChildPointsWidgetState extends State<MyChildPointsWidget> {
  @override
